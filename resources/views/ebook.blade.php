  ...
  <div class="form-card">
    ...
    <div class="card-body">
      <div class="form-group">
        ...
        <input id="titulo" name="titulo" type="text" placeholder="Ex: As Crônicas de Nárnia">
      </div>
      <div class="form-group">
        <label><i class="fas fa-user"></i> Autor(a) *</label>
        <input id="autor" name="autor" type="text" placeholder="Seu nome">
      </div>
      <div class="form-group">
      ...
      <div class="form-group">
        ...
        <textarea rows="2" placeholder="Breve descrição..." id="sinopse" name="sinopse"></textarea>
      </div>
      <div class="form-group">
        <label><i class="fas fa-paragraph"></i> Conteúdo completo *</label>
        <textarea rows="6" placeholder="Digite aqui o conteúdo do seu e-book..." id="texto" name="texto"></textarea>
      </div>
      <button type="submit" id="meuid" class="btn-publicar">
        <i class="fas fa-cloud-upload-alt"></i> Publicar E-book
      </button>
    </div>
  </div>
</div>
...
<script>
  $(document).ready(function(){
    ...
    if(res['erro'] == 'n'){
        Swal.fire({
            title: '<strong style="font-family: Cormorant Garamond;">E-book publicado!</strong>',
            html: `
                <div style="font-family: Cormorant Garamond; font-size: 1.1rem;">
                    Seu livro já está disponível na plataforma 📚<br>
                    <span style="color:#b78c5a;">Parabéns pela publicação!</span>
                </div>
            `,
            icon: 'success',
            background: 'linear-gradient(135deg, #f0e8de, #e7ddd1)',
