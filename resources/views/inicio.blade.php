        ...
        <form id="livroForm">
            <div class="form-grid">
                <div class="field-group">
                    ...
                    <input type="text" id="titulo" name="titulo" placeholder="Ex: O Nome do Vento" required>
                ...
                <div class="field-group">
                    ...
                    <input type="text" id="autor" name="autor" placeholder="Sobrenome, Nome" required>
                ...
                <div class="field-group">
                    ...
                    <input type="number" id="ano_publicacao" name="ano_publicacao" placeholder="ex: 2021" min="1000" max="2100" required>
                ...
                <div class="field-group">
                    ...
                    <input type="number" id="paginas" name="paginas" placeholder="240" min="1" max="10000" required>
                ...
                <div class="field-group full-width">
                    ...
                    <input type="text" id="editora" name="editora" placeholder="Companhia das Letras, Alfaguara..." required>
            ...
            <div class="inline-duo">
                <div class="field-group">
                    ...
                    <input type="text" id="preco" name="preco" placeholder="59,90" required>
...
<script>
document.getElementById("meuid").addEventListener("click", function () {
    Swal.fire({
        ...
        html: `
            <div class="swal-card-clean">
                <div class="swal-badge-check">
                    ✓
                </div>
                <div class="swal-content-clean">
                    <h2>Livro cadastrado</h2>
                    <p>O livro foi adicionado com sucesso ao acervo.</p>
                    <button id="swalCloseBtn">Continuar</button>
                </div>
            </div>
        `,
        didOpen: () => {
...
.swal-badge-check {
    ...
    align-items: center;
    justify-content: center;
    box-shadow: 0 10px 25px rgba(31,191,115,0.35);
    font-family: 'Montserrat', sans-serif;
}
